...
public class President extends VoterChoice {
	...
	public President(int setedVote, int vote, int confirm, int blank, int voteNull, int ciroGomes, int lula,
		...
		President.vote = vote;
		President.confirm = confirm;
		President.blank = blank;
		President.voteNull = voteNull;
	...
	public void SetImage() {
		if (PrimaryPanel.office.getText().equals("PRESIDENTE")) {
			...
			if (vote == 12) {
				Image img12 = new ImageIcon(this.getClass().getResource("/12.jpg")).getImage().getScaledInstance(120,
				...
				Image imgv12 = new ImageIcon(this.getClass().getResource("/v12.jpg")).getImage().getScaledInstance(60,
						75, Image.SCALE_SMOOTH);
				PrimaryPanel.viceImg.setIcon(new ImageIcon(imgv12));
			}

			if (vote == 13) {
				Image img13 = new ImageIcon(this.getClass().getResource("/13.jpg")).getImage().getScaledInstance(120,
						160, Image.SCALE_SMOOTH);
				...
				Image imgv13 = new ImageIcon(this.getClass().getResource("/v13.jpg")).getImage().getScaledInstance(60,
						75, Image.SCALE_SMOOTH);
				PrimaryPanel.viceImg.setIcon(new ImageIcon(imgv13));
			}

			if (vote == 14) {
				Image img14 = new ImageIcon(this.getClass().getResource("/14.jpg")).getImage().getScaledInstance(120,
						160, Image.SCALE_SMOOTH);
				...
				Image imgv14 = new ImageIcon(this.getClass().getResource("/v14.jpg")).getImage().getScaledInstance(60,
						75, Image.SCALE_SMOOTH);
				PrimaryPanel.viceImg.setIcon(new ImageIcon(imgv14));
			}

			if (vote == 15) {
				Image img15 = new ImageIcon(this.getClass().getResource("/15.jpg")).getImage().getScaledInstance(120,
						160, Image.SCALE_SMOOTH);
			...
			if (vote == 16) {
				Image img16 = new ImageIcon(this.getClass().getResource("/16.jpg")).getImage().getScaledInstance(120,
						160, Image.SCALE_SMOOTH);
				...
				Image imgv16 = new ImageIcon(this.getClass().getResource("/v16.jpg")).getImage().getScaledInstance(60,
						75, Image.SCALE_SMOOTH);
				PrimaryPanel.viceImg.setIcon(new ImageIcon(imgv16));
			}

			if (vote == 21) {
				Image img21 = new ImageIcon(this.getClass().getResource("/21.jpg")).getImage().getScaledInstance(120,
						160, Image.SCALE_SMOOTH);
				...
				Image imgv21 = new ImageIcon(this.getClass().getResource("/v21.jpg")).getImage().getScaledInstance(60,
						75, Image.SCALE_SMOOTH);
				PrimaryPanel.viceImg.setIcon(new ImageIcon(imgv21));
			}

			if (vote == 22) {
				Image img22 = new ImageIcon(this.getClass().getResource("/22.jpg")).getImage().getScaledInstance(120,
						160, Image.SCALE_SMOOTH);
				...
				Image imgv22 = new ImageIcon(this.getClass().getResource("/v22.jpg")).getImage().getScaledInstance(60,
						75, Image.SCALE_SMOOTH);
				PrimaryPanel.viceImg.setIcon(new ImageIcon(imgv22));
			}

			if (vote == 27) {
				Image img27 = new ImageIcon(this.getClass().getResource("/27.jpg")).getImage().getScaledInstance(120,
						160, Image.SCALE_SMOOTH);
				...
				Image imgv27 = new ImageIcon(this.getClass().getResource("/v27.jpg")).getImage().getScaledInstance(60,
						75, Image.SCALE_SMOOTH);
				PrimaryPanel.viceImg.setIcon(new ImageIcon(imgv27));
			}

			if (vote == 30) {
				Image img30 = new ImageIcon(this.getClass().getResource("/30.jpg")).getImage().getScaledInstance(120,
						160, Image.SCALE_SMOOTH);
				...
				Image imgv30 = new ImageIcon(this.getClass().getResource("/v30.jpg")).getImage().getScaledInstance(60,
						75, Image.SCALE_SMOOTH);
				PrimaryPanel.viceImg.setIcon(new ImageIcon(imgv30));
			}

			if (vote == 44) {
				Image img44 = new ImageIcon(this.getClass().getResource("/44.jpg")).getImage().getScaledInstance(120,
						160, Image.SCALE_SMOOTH);
				...
				Image imgv44 = new ImageIcon(this.getClass().getResource("/v44.jpg")).getImage().getScaledInstance(60,
						75, Image.SCALE_SMOOTH);
				PrimaryPanel.viceImg.setIcon(new ImageIcon(imgv44));
			}

			if (vote == 80) {
				Image img80 = new ImageIcon(this.getClass().getResource("/80.jpg")).getImage().getScaledInstance(120,
						160, Image.SCALE_SMOOTH);
				...
				Image imgv80 = new ImageIcon(this.getClass().getResource("/v80.jpg")).getImage().getScaledInstance(60,
						75, Image.SCALE_SMOOTH);
				PrimaryPanel.viceImg.setIcon(new ImageIcon(imgv80));
			}

			if (vote == 90) {
				Image img90 = new ImageIcon(this.getClass().getResource("/90.jpg")).getImage().getScaledInstance(120,
						160, Image.SCALE_SMOOTH);
				...
				Image imgv90 = new ImageIcon(this.getClass().getResource("/v90.jpg")).getImage().getScaledInstance(60,
						75, Image.SCALE_SMOOTH);
